import unittest
import numpy
from goombay import WatermanSmithBeyerLocal


class TestWatermanSmithBeyerLocal(unittest.TestCase):
    """Test suite for Smith-Waterman local alignment algorithm"""

    def setUp(self):
        """Initialize algorithm for tests"""
        self.algorithm = WatermanSmithBeyerLocal()
    ...
    def test_scoring_parameters(self):
        ...
        custom_algorithm = WatermanSmithBeyerLocal(match=1, mismatch=2, new_gap=3)
